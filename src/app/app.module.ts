...
@NgModule({
  declarations: [AppComponent, TabContainerComponent, CeasarCipherComponent, VigenereCipherComponent, Sha256CipherComponent, ExplainModalComponent, ReferenceComponent],
